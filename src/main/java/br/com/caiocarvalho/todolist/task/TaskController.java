package br.com.caiocarvalho.todolist.task;

import br.com.caiocarvalho.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request){
        ...
        if(taskModel.getStartAt().isAfter(taskModel.getEndAt())){
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Data de inicio deve ser menor do que a data de termino");
        }
    ...
    // http:localhost:8080/tasks/id-da-task-pra-alterar
    @PutMapping("/{id}")
